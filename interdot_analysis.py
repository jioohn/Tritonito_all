# -*- coding: utf-8 -*-
"""
Created on Wed Apr 21 19:35:02 2021
...
continuous_acquisition()
continuous_acquisition_ch2()
name=str(Bfield())+'T_G3vsG4pulsing3stage1us_G1'+str(VG1())+'mV_G2'+str(VG2())+'mV_G3'+str(VG3())+'mV_G4'+str(VG4())+'mV_G5'+str(VG5())+'mV_G6'+str(VG6())+'mV'
a,dataid,c,d=sweep2D(VG3comp,-822,-827,51,0.02,VG4comp,-843,-848,51,0.015,ph1,ph2)
...
startG3=-824.8
stopG3=-824
pathS=folder2+'\\'+dayFolder+'\\'+str(Bfield())+'_T_VG3='+str(startG3)+'_mV_VG4='+str(startG4)+'mV_phS_'
path2S = pathS + f'/time_traces'
pathD=folder2+'\\'+dayFolder+'\\'+str(Bfield())+'_T_VG3='+str(startG3)+'_mV_VG4='+str(startG4)+'mV_phD_'
...
#     Name = re.sub('../../exploration','',path)       
    ...
    # if np.max(gamma_up)>10e3 or np.max(gamma_down)>50e3:
    #     plt.ylim(0,40)
