# -*- coding: utf-8 -*-
"""
Created on Fri Jul  9 14:52:40 2021
...
# ziUhf.daq.setInt('/dev2226/demods/0/phaseadjust', 1)
a,b,c=sweep1D(G1freq,initfG,finalfG,points,0.03,A1)
...
# ziUhf.daq.setInt('/dev2226/demods/0/phaseadjust', 1)
# ziUhf.daq.setInt('/dev2226/demods/0/phaseadjust', 1)
a,b,c=sweep1D(Sfreq,initfD,finalfD,points,0.03,A2)
...
# a,b,c,d =sweep2D(Sfreq,290e6,310e6,201,0.03,VG6,-1914,-1918,121,0.03,A2,ph2)
...
# a,b,c,d =sweep2D(G1freq,400e6,420e6,201,0.03,VG6,-1914,-1918,121,0.03,A1,ph1)
# the_data = load_by_id(b)
# data_list = the_data.get_parameter_data()
# P = the_data.parameters
# p = P.split(',')
...
if zerophase:
    ...
    time.sleep(0.5)
    ziUhf.daq.setInt('/dev2226/demods/0/phaseadjust', 1)
a,b,c=sweep1D(G1freq,initfG,finalfG,points,0.03,ph1)
...
if zerophase:
    ...
    time.sleep(0.5)
    ziUhf.daq.setInt('/dev2226/demods/4/phaseadjust', 1)
a,b,c=sweep1D(Sfreq,initfD,finalfD,points,0.03,ph2)
