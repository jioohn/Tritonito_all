# -*- coding: utf-8 -*-
"""
Created on Tue May 11 17:40:06 2021
...
ampli_list=np.linspace(-0,-0.4,Npoints)
# ampliAWG(0.2)
traceavgS=[]
traceavgD=[]
...
title=str(Bfield())+'T_phS_3stage__ampliAWGvstime_50usramp_G3overG4ampli'+str(np.round(ziUhf.daq.getDouble('/dev2010/auxouts/0/scale')/ziUhf.daq.getDouble('/dev2010/auxouts/1/scale'),3))+'_G4'+str(VG4())+'mV_G3'+str(VG3())+'mV__'
...
plt.ylabel('$\epsilon (mV)$',fontsize=18)
...
title=str(Bfield())+'T_phD_3stage__ampliAWGvstime_50usramp_G3overG4ampli'+str(np.round(ziUhf.daq.getDouble('/dev2010/auxouts/0/scale')/ziUhf.daq.getDouble('/dev2010/auxouts/1/scale'),3))+'_G4'+str(VG4())+'mV_G3'+str(VG3())+'mV__'
