# -*- coding: utf-8 -*-
"""
Created on Wed Jul  7 15:18:16 2021
...
if zerophase:
    ...
    time.sleep(0.5)
    ziUhf.daq.setInt('/dev2226/demods/0/phaseadjust', 1)
a,b,c=sweep1D(G1freq,initfG,finalfG,points,0.02,x1)
...
# ziUhf.daq.setInt('/dev2226/demods/0/phaseadjust', 1)
# ziUhf.daq.setInt('/dev2226/demods/0/phaseadjust', 1)
a,b,c=sweep1D(G1freq,initfG,finalfG,points,0.02,y1)
...
if zerophase:
    ...
    time.sleep(0.5)
    ziUhf.daq.setInt('/dev2226/demods/4/phaseadjust', 1)
a,b,c=sweep1D(Sfreq,initfD,finalfD,points,0.02,x2)
...
# ziUhf.daq.setInt('/dev2226/demods/0/phaseadjust', 1)
# ziUhf.daq.setInt('/dev2226/demods/0/phaseadjust', 1)
a,b,c=sweep1D(Sfreq,initfD,finalfD,points,0.02,y2)
...
a,b,c=sweep1D(VG6,initG6,finalG6,points,0.02,x1,y1,x2,y2)
plot_by_id(b)
