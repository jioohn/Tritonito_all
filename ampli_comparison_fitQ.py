# -*- coding: utf-8 -*-
"""
Created on Wed Jul  7 16:09:01 2021
...
# ziUhf.daq.setInt('/dev2226/demods/0/phaseadjust', 1)
a,b,c=sweep1D(G1freq,initfG,finalfG,points,0.05,A1)
...
plt.plot(data_set*1e-6 ,dphi_on,label='on resonance VG6='+str(Vres)+'mV Q='+str(Q_on))
# plt.title('Id vs $V_{g}$')
plt.xlabel(xlabel,fontsize=16)
...
ziUhf.daq.setInt('/dev2226/sigouts/0/on', 0)
ziUhf.daq.setInt('/dev2226/sigouts/1/on', 1)
a,b,c=sweep1D(VG6,finalG6-1,finalG6+1,points,0.02,A2,ph1)
plot_by_id(b)
name='_G6_'+str(VG6())+'mv_G5'+str(VG5())+'mV'+'_G6resonance'
# plt.rcParams["figure.figsize"]=(12,9)
# plt.rcParams["label.labelsize"]=16
...
# ziUhf.daq.setInt('/dev2226/sigouts/0/on', 0)
# ziUhf.daq.setInt('/dev2226/sigouts/1/on', 1)
# a,b,c=sweep1D(VG6,-1940,-1900,1001,0.02,ph2)
# plot_by_id(b)
# name='_G6_'+str(VG6())+'mv_G5'+str(VG5())+'mV'+'_G6resonance'
# # plt.rcParams["figure.figsize"]=(12,9)
# # plt.rcParams["label.labelsize"]=16
