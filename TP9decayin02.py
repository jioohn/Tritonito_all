# -*- coding: utf-8 -*-
"""
Created on Mon Dec  7 19:51:00 2020
...
#    tguessarray2.append(tguess2)
    ...
    if i==0:
        ...
        G1now=VG1()
        while VG4()<-916:
            a,dataid,c=sweep1D(VG4comp, -916.5,-914.5,201,0.02,ph1)
            #####################check sensorsignal
            xlabel='$V_{G4}$(mV)'
            ylabel='$\phi_{G1}$(deg)'
    ...
    phimax=np.max(phase)
    phimin=np.min(phase)
    popt,pcov = curve_fit(fit_exponential_nodelay,taxis,M2[i],p0=[100e-6,phimax-phimin,phimin],maxfev=10000)    
    ...
    plt.legend(loc='upper right')
    plt.show()
    name='TP9_decayfitin11_amplitude_pp_'+str(ampliAWG()*11)+'mV_500rep_B'+str(Bfield())+'T_G1'+str(VG1())+'mV_G2'+str(VG2())+'mV_G3'+str(VG3())+'mV_G4'+str(VG4())+'mV'+str(VG5())+'mV'
...
name='TP9__timevsfield_amplitude_pp_'+str(ampliAWG()*11)+'mV_1000rep_B'+str(Bfield())+'T_G1'+str(VG1())+'mV_G2'+str(VG2())+'mV_G3'+str(VG3())+'mV_G4'+str(VG4())+'mV_G5'+str(VG5())+'mV'
...
ax.set_xlabel('time(s)',fontsize=fontSize)
ax.set_ylabel('$B$ (T)',fontsize=fontSize)
name='TP9__timevsfield_in11_amplitude_pp_'+str(ampliAWG()*11)+'mV_1000rep_B'+str(Bfield())+'T_G1'+str(VG1())+'mV_G2'+str(VG2())+'mV_G3'+str(VG3())+'mV_G4'+str(VG4())+'mV_G5'+str(VG5())+'mV'
# name='TP7____timein11sfield_amplitude_pp_'+str(np.round(ampliAWG()*11,4))+'mV_1000rep_B'+str(Bfield())+'T_G1'+str(VG1())+'mV_G2'+str(VG2())+'mV_G3'+str(VG3())+'mV_G4'+str(VG4())+'mV'
...
name='TP9__decaytimevsfield_amplitude_pp_'+str(ampliAWG()*11)+'mV_500rep_B'+str(Bfield())+'T_G1'+str(VG1())+'mV_G2'+str(VG2())+'mV_G3'+str(VG3())+'mV_G4'+str(VG4())+'mV'
...
name='TP9__decaytime11vsfield_amplitude_pp_'+str(ampliAWG()*11)+'mV_500rep_B'+str(Bfield())+'T_G1'+str(VG1())+'mV_G2'+str(VG2())+'mV_G3'+str(VG3())+'mV_G4'+str(VG4())+'mV'
# name='TP7____decaytimein11sfield_amplitude_pp_'+str(np.round(ampliAWG()*11,4))+'mV_1000rep_B'+str(Bfield())+'T_G1'+str(VG1())+'mV_G2'+str(VG2())+'mV_G3'+str(VG3())+'mV_G4'+str(VG4())+'mV'
# plt.plot(ydata,tempty,'b+',label='data')
...
name='TP9_alphavsfield_amplitude_pp_'+str(ampliAWG()*11)+'mV_500rep_B'+str(Bfield())+'T_G1'+str(VG1())+'mV_G2'+str(VG2())+'mV_G3'+str(VG3())+'mV_G4'+str(VG4())+'mV'
# name='TP7____decaytimein11sfield_amplitude_pp_'+str(np.round(ampliAWG()*11,4))+'mV_1000rep_B'+str(Bfield())+'T_G1'+str(VG1())+'mV_G2'+str(VG2())+'mV_G3'+str(VG3())+'mV_G4'+str(VG4())+'mV'
# plt.plot(ydata,tempty,'b+',label='data')
...
name='TP9__G4vsfield_amplitude_pp_'+str(ampliAWG()*11)+'mV_500rep_B'+str(Bfield())+'T_G1'+str(VG1())+'mV_G2'+str(VG2())+'mV_G3'+str(VG3())+'mV_G4'+str(VG4())+'mV'
# name='TP7____decaytimein11sfield_amplitude_pp_'+str(np.round(ampliAWG()*11,4))+'mV_1000rep_B'+str(Bfield())+'T_G1'+str(VG1())+'mV_G2'+str(VG2())+'mV_G3'+str(VG3())+'mV_G4'+str(VG4())+'mV'
...
name='TP9__G1vsfield_amplitude_pp_'+str(ampliAWG()*11)+'mV_500rep_B'+str(Bfield())+'T_G1'+str(VG1())+'mV_G2'+str(VG2())+'mV_G3'+str(VG3())+'mV_G4'+str(VG4())+'mV'
# name='TP7____decaytimein11sfield_amplitude_pp_'+str(np.round(ampliAWG()*11,4))+'mV_1000rep_B'+str(Bfield())+'T_G1'+str(VG1())+'mV_G2'+str(VG2())+'mV_G3'+str(VG3())+'mV_G4'+str(VG4())+'mV'
